...
CONDUCTORS IN SERIES v01.06 README
==================================
...
-----------
  ...
  This program simulates a heat energy flow through conductors in series.
  In this simulation, the thermal difference is of a fixed magnitude.
...
-------------------
  ...
  Then enter:
    ...
    ruby conductors_in_series_v01.06.rb
